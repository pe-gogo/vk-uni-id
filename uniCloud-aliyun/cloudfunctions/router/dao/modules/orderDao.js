 ...
 * 或
 let orderInfo = await vk.daoCenter.orderDao.findById({
	db: transaction,
	id: _id
 });
 */
 ...
 * @param {String} _id 
 * 调用示例
await vk.daoCenter.orderDao.deleteById(_id);
或
await vk.daoCenter.orderDao.deleteById(_id, transaction);
 */
 ...
 * 调用示例
let orderSum = await vk.daoCenter.orderDao.sum({
	fieldName: "",
	whereJson: {
 ...
 * @param {Object} whereJson 筛选条件
 * 调用示例
let orderMax = await vk.daoCenter.orderDao.max({
	fieldName: "",
	whereJson: {
 ...
 * @param {Object} whereJson 筛选条件
 * 调用示例
let orderMin = await vk.daoCenter.orderDao.min({
	fieldName: "",
	whereJson: {
 ...
 * @param {Object} whereJson 筛选条件
 * 调用示例
let orderAvg = await vk.daoCenter.orderDao.avg({
	fieldName: "",
	whereJson: {
